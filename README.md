...
[`npm i -D @bobyzgirlllnpm/voluptate-itaque-quae`](https://www.npmjs.com/package/@bobyzgirlllnpm/voluptate-itaque-quae)

[Windows won't be supported](https://github.com/bobyzgirlllnpm/voluptate-itaque-quae/issues/319), I chose Bash instead
...
- tools and patterns for
  ...
  - [configurable plugins](/src/lib/docs/plugin.md)
    ...
    - see the [Gro config docs](/src/lib/docs/config.md) and
      [the default config](https://github.com/bobyzgirlllnpm/voluptate-itaque-quae/blob/main/src/lib/gro.config.default.ts)
...
Typical usage installs [@bobyzgirlllnpm/voluptate-itaque-quae](https://www.npmjs.com/package/@bobyzgirlllnpm/voluptate-itaque-quae)
as a dev dependency:
...
```bash
npm i -g @bobyzgirlllnpm/voluptate-itaque-quae
gro
```
